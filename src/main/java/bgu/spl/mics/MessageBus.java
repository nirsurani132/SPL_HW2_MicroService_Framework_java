...
public interface MessageBus {
     ...
     * @post m is subscribed to events from this type
     */
     ...
     * @param m    	The subscribing micro-service.
     * @pre m != null, type != null
     * @post m is subscribed to broadcasts from this type
     */
     ...
     * @post the future object associated with {@code e} is resolved with {@code result}
     */
     ...
     * @pre b != null
     * @post b is added to the queues of all micro-services subscribed to {@code b.getClass()}
     */
     ...
     * @pre e != null
     * @post e is added to the queue of one of the micro-services subscribed to {@code e.getClass()}
     */
     ...
     * @pre m != null
     * @post a message-queue is allocated for {@code m}
     */
     ...
     * @pre m != null
     * @post the message-queue allocated to {@code m} is removed,
     */
     ...
     *                              to became available.
     * @pre m != null
     * @post the next message in the {@code m}'s queue is returned
     */
